 ...
 * @author tan
 */
@WebServlet(name = "EmployeeChangePasswordServlet", urlPatterns = {"/EmployeeChangePasswordServlet"})
public class EmployeeChangePasswordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pass = request.getParameter("loginpwd");
   ...
   out.println("alert('Password is updated Successfully');");
