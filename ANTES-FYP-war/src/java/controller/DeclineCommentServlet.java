 ...
 * @author tan
 */
@WebServlet(name = "DeclineCommentServlet", urlPatterns = {"/DeclineCommentServlet"})
public class DeclineCommentServlet extends HttpServlet {
   ...
   out.println("</script>");
                ...
                out.println("<script type=\"text/javascript\">");
   out.println("alert('Declination cannot be processed temporary. Please try again later );");
   out.println("location='employeenetwork.jsp';");
   out.println("</script>");
            }
        }
