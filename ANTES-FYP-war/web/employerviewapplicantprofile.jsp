<%-- 
    Document   : employerviewapplicantprofile
    Created on : Feb 12, 2018, 2:21:59 AM
    Author     : tan
--%>
...
<html>
    <head>
        ...
        <title>Employer-viewEmployeeProfile</title>
    </head>
    <style>
    ...
    String in = request.getParameter("intro");
     in= in.replaceAll("(\r\n|\n)", "<br>");
%>
<%
        ...
        <div class="tab-content"> 
                    <div id="editcompanyinfo" class="tab-pane fade in active">
                        ...
                        <div class="body">
                            <div>
                                <div class="col-sm-6">
                                    <img src="employeepicture.jsp?emID=<%= resultSet.getString("ID")%>" id="profilepic" name="profilepic" alt="Profile Pic" style="width:200px;height:200px;border: 3px solid #ccc;"><br>
                                                </div>
                                <div class="col-sm-6 text-justify" align="left">
                                    <br>
                                    <br>
                                    <br>
                                    <br>
                                ...
                                <div class="form-group">
                                    <label for="companyname"><h1 class="cname"><%= resultSet.getString("LNAME")%> <%= resultSet.getString("FNAME")%></h1></label><br>
                                    <label for="network"><a href="usernetwork.jsp?adid=<%= resultSet.getString("ID")%>" target="blank">View Applicant Network</a></label>
                                    <br>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="Gender"><h2 >Gender: </h2></label>
                                    <p class="gender"><%= resultSet.getString("GENDER")%></p>
                                </div>
                                <div class="form-group">
                                    <label for="nation"><h2 >Nationality: </h2></label>
                                    <p class="nation"><%= resultSet.getString("NATIONALITY")%></p>
                                </div>
                                <br>
                                <div class="form-group">
                                ...
                                <% 
                                    if(in.equalsIgnoreCase("null")){
                                        ...
                                        %>        
                                <div class="form-group">
                                    <label for="introduction"><h2 >Speak for the Job!</h2></label>
                                    <p class="intro"><%
                                        out.println(in);
                                               %></p>
                                ...
                                <div class="form-group" style="border:1px solid #ccc;">
                                    ...
                                    <p class="clocate"> <%
                                     ...
                                     <div class="col-sm-6 text-justify">
                                        ...
                                        <br>
                                    <p class="ccontact">Contact Number: <%= resultSet.getString("PHONENO")%></p>   
                                    <br>
